...
import { CapIcon, IconLogo, WatchLogo } from "./ui/Icons";
...
const Hero = () => {
  ...
  return (
    <section
      className="bg-white min-h-screen overflow-hidden lg:max-h-full mx-auto padding-container space-x-0 lg:space-x-12 background-map lg: pt-12"
      id="Hero"
    >
      <header className="lg:max-w-screen-2xl max-w-full flex flex-wrap items-center justify-between mx-auto lg:p-4 p-1">
        <Link
          ...
          data-aos="fade-right"
        >
          <WatchLogo className="fill-white lg:w-[60px] h-[50px] w-[50px]" />
      ...
      <main className="flex flex-col items-center justify-center px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32 min-h-[calc(100vh-80px)]">
        <h1 className="text-4xl md:text-6xl text-white text-center w-full md:w-[900px] mx-auto mt-14 md:mt-28 font-sans font-[500]">
          Relógios Exclusivos para Cada Momento da Sua Vida
        </h1>
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start w-full md:w-[70vw] mx-auto mt-10 md:mt-12">
          <div className="flex flex-col md:w-[600px] lg:mr-12">
            <h2
              className="text-white font-normal lg:text-lg text-sm text-center md:w-[600px] mx-auto"
              data-aos="zoom-in"
            >
              Desde clássicos atemporais até as mais modernas criações, nossa
              coleção de relógios de pulso antigos e novos eleva seu estilo e
              pontualidade.
            </h2>
            <div className="flex flex-col md:flex-row mt-10 md:mt-20 items-center justify-center space-x-6 ">
              <Link
                href="#Form"
                className="flex flex-row bg-gray-900 hover:bg-gray-800 py-5 px-6 w-full md:w-[270px] rounded-full cursor-pointer justify-between shadow-lg mb-4 md:mb-0"
                data-aos="fade-up"
                data-aos-delay="200"
              >
              ...
              >
                ...
                <WatchLogo className="fill-black " />
              </Link>
            </div>
          </div>
        </div>
